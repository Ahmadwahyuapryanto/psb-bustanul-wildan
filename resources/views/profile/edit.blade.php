    ...
    <main class="flex-1 overflow-y-auto">
        <div class="p-8 md:p-12 max-w-4xl mx-auto h-full flex flex-col relative">
            ...
            <div class="mb-10">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mb-3">Profil Saya</h2>
            ...
            <div class="space-y-8 flex-1">
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                        ...
                        <div class="pt-4 border-t border-gray-100">
                            <button type="submit" class="bg-[#0B3B2C] hover:bg-[#082a20] text-white px-6 py-3 rounded-xl text-sm font-bold transition shadow-md">
                                Simpan Perubahan
                            </button>
                        </div>
                    </form>
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                    ...
                    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                        ...
                        <div class="pt-4 border-t border-gray-100">
                            <button type="submit" class="bg-[#8C6B14] hover:bg-amber-700 text-white px-6 py-3 rounded-xl text-sm font-bold transition shadow-md">
                                Perbarui Kata Sandi
                            </button>
                        </div>
                    </form>
            ...
            <footer class="mt-8 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
