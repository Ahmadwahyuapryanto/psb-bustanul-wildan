...
<body class="bg-[#F8FAFC] text-gray-800 font-figtree antialiased">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-emerald-800 text-white border-t border-emerald-700 shadow-lg">
        <div class="px-6 py-4 space-y-3 text-sm">
            ...
            <a href="{{ route('panduan') }}" class="block text-amber-500 font-semibold border-b border-emerald-700 pb-2">Panduan</a>
    ...
    <!-- SEMUA KODE DI BAWAH INI TIDAK SAYA UBAH SAMA SEKALI -->
