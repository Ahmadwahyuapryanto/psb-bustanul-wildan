    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between flex-shrink-0 h-full z-20">
        ...
        <div>
            ...
            <nav class="px-4 space-y-2">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-[#0B3B2C] rounded-xl text-sm font-semibold transition">
        ...
        <div class="px-6 pb-8">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <p class="text-sm font-bold text-gray-900 leading-none mb-1">{{ explode(' ', Auth::user()->name)[0] }}</p>
        ...
        <div class="p-8 md:p-12 max-w-5xl mx-auto h-full flex flex-col relative">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                <div>
                    ...
                    <h2 class="text-4xl font-bold text-gray-900 mb-3">Selamat Datang, {{ explode(' ', Auth::user()->name)[0] }}.</h2>
                ...
                <div class="text-right">
                    ...
                    <p class="text-lg font-bold text-[#0B3B2C] bg-gray-100 px-4 py-1.5 rounded-lg border border-gray-200">
            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-6">
                ...
                <div class="relative flex justify-between">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="w-12 h-12 {{ ($santri && $santri->tahap_pendaftaran >= 6) ? 'bg-[#8C6B14] text-white shadow-md' : 'bg-gray-100 text-gray-400' }} rounded-full flex items-center justify-center border-4 border-white mb-3 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        </div>
                    ...
                    <div class="flex flex-col items-center">
                        <div class="w-12 h-12 {{ ($santri && in_array($santri->status_pendaftaran, ['diverifikasi', 'lulus', 'tidak lulus'])) ? 'bg-[#8C6B14] text-white shadow-md' : (($santri && $santri->status_pendaftaran == 'menunggu') ? 'bg-[#8C6B14] text-white shadow-md ring-4 ring-amber-50' : 'bg-gray-100 text-gray-400') }} rounded-full flex items-center justify-center border-4 border-white mb-3 transition-colors">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="w-12 h-12 {{ ($santri && in_array($santri->status_pendaftaran, ['lulus', 'tidak lulus'])) ? 'bg-[#8C6B14] text-white shadow-md' : (($santri && $santri->status_pendaftaran == 'diverifikasi') ? 'bg-[#8C6B14] text-white shadow-md ring-4 ring-amber-50' : 'bg-gray-100 text-gray-400') }} rounded-full flex items-center justify-center border-4 border-white mb-3 transition-colors">
                    ...
                    <div class="flex flex-col items-center">
                        <div class="w-12 h-12 {{ ($santri && $santri->status_pendaftaran == 'lulus') ? 'bg-emerald-500 text-white shadow-md ring-4 ring-emerald-50' : (($santri && $santri->status_pendaftaran == 'tidak lulus') ? 'bg-rose-500 text-white shadow-md ring-4 ring-rose-50' : 'bg-gray-100 text-gray-400') }} rounded-full flex items-center justify-center border-4 border-white mb-3 transition-colors">
            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-start relative overflow-hidden flex-1 mb-8">
                <div class="absolute right-0 top-0 w-64 h-full bg-gradient-to-l from-{{ $statusInfo['color'] ?? 'gray' }}-50/50 to-transparent"></div>
                ...
                <div class="md:w-2/3 border-l-2 border-{{ $statusInfo['color'] ?? 'gray' }}-200 pl-6 relative z-10">
                    <div class="relative">
                        ...
                        @if(!$santri || $santri->tahap_pendaftaran < 6)
                            <a href="{{ route('pendaftaran.step1') }}" class="inline-flex items-center gap-2 bg-[#0B3B2C] text-white px-5 py-2.5 rounded-xl text-xs font-bold hover:bg-[#082a20] transition shadow-sm">
