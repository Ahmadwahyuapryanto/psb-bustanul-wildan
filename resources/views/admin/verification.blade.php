    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-hidden p-6">
            <div class="max-w-7xl mx-auto h-full flex flex-col lg:flex-row gap-6">
                ...
                @if(session('success'))
                    <div class="absolute top-24 left-1/2 transform -translate-x-1/2 bg-emerald-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 text-sm font-bold">
                        {{ session('success') }}
                    </div>
                @endif
                @if(session('error'))
                    <div class="absolute top-24 left-1/2 transform -translate-x-1/2 bg-rose-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 text-sm font-bold">
                        {{ session('error') }}
                    </div>
                @endif

                <div class="flex-1 bg-white rounded-3xl border border-gray-100 shadow-sm flex flex-col overflow-hidden relative h-full">
                    ...
                    <div class="p-4 border-t border-gray-100 bg-white flex justify-between items-center">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="w-32 bg-gray-200 h-1.5 rounded-full">
                ...
                <div class="w-full lg:w-[350px] flex flex-col gap-6 overflow-y-auto">
                    ...
                    <div class="bg-[#0B3B2C] rounded-3xl p-6 text-white relative overflow-hidden shadow-md">
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex-1 flex flex-col">
