            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('pendaftaran.step2.store') }}" method="POST">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200 mb-10">
                        <a href="{{ route('pendaftaran.step1') }}" class="text-gray-500 hover:text-gray-800 font-bold text-sm flex items-center gap-2 bg-white border border-gray-200 px-6 py-3 rounded-xl shadow-sm transition w-full sm:w-auto justify-center">
