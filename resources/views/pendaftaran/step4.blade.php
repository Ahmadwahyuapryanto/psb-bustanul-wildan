    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="w-72 bg-white border-r border-gray-200 p-6 hidden md:block overflow-y-auto">
            ...
            <nav class="space-y-1">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-emerald-700 hover:bg-emerald-50 rounded-xl font-bold transition border border-transparent">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <form action="{{ route('pendaftaran.step4.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200">
                        <a href="{{ route('pendaftaran.step3') }}" class="text-gray-500 hover:text-gray-800 font-bold text-sm flex items-center gap-2 bg-white border border-gray-200 px-6 py-3 rounded-xl shadow-sm transition w-full sm:w-auto justify-center">
